...
import { styles } from "./stylesEmpowerBusiness"
        ...
        <Box sx={styles.main}>
            <Box sx={styles.head}>
                <Box sx={styles.headTitleContainer}>
                    <Typography variant="h5" component='h5' sx={styles.headTitle}>Empower your business  with our services</Typography>
                </Box>
